...
SAVE_FOLDER = 'dataset/UCMerced_21'
...
if __name__ == "__main__":
    ...
    work(model, num_shot_per_class, location, num_qns_per_round, test_df, demo_df, classes, class_desp, SAVE_FOLDER, file_suffix, exclude, dataset_name)
